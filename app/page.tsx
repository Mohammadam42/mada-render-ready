  ...
  return (
    <main>
      <header className="site-header">
        <div className="container header-inner">
          ...
          <nav className={menuOpen ? "main-nav open" : "main-nav"} aria-label="التنقل الرئيسي">
            ...
            <a href="#governance" onClick={() => setMenuOpen(false)}>منهج المكتبة</a>
      ...
      <section className="governance-section" id="governance">
        <div className="container">
          <div className="section-heading centered">
            <span>منهج عمل مَدى</span>
            <h2>مكتبة منظمة، لا مجرد ملفات.</h2>
            <p>كل مادة تُراجع قبل ظهورها للطالب، وتُفهرس لتُكتشف بسهولة، ويُوثق مصدرها وحق استخدامها.</p>
          </div>
          <div className="governance-grid">
            <article><span>01</span><BookMarked /><h3>فهرسة موحدة</h3><p>عنوان، مؤلف، مرحلة، موضوع، وصف، نوع مورد ورابط مصدر لكل مادة.</p></article>
            <article><span>02</span><Search /><h3>بحث دقيق</h3><p>فلترة حسب المرحلة والموضوع، ثم الانتقال إلى مصدر القراءة المعتمد.</p></article>
            <article><span>03</span><ShieldCheck /><h3>حقوق وحماية</h3><p>لا نستضيف نسخًا غير مرخصة، وتُراجع الحقوق والمصادر قبل اعتماد المحتوى.</p></article>
          </div>
        </div>
      </section>
      ...
      <footer>
        <div className="container footer-main">
          ...
          <div className="footer-links"><a href="#library">الكتب</a><a href="#stages">المراحل</a><a href="#why">عن مَدى</a><a href="#governance">منهج المكتبة</a><a href="#rights">حقوق النشر</a></div>
        </div>
